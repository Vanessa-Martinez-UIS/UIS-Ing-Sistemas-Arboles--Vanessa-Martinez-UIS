...
class Arbol:
    ...
    def agregar_nodo(self, dato, padre=None):
        nuevo = Nodo(dato)
    ...
    def orden(self):
        def calcular(nodo):
            ...
            for _ in nodo.hijos:
                hijos_actuales += 1
            mayor = hijos_actuales
            for hijo in nodo.hijos:
                hijos_del_hijo = calcular(hijo)
                if hijos_del_hijo > mayor:
                    mayor = hijos_del_hijo
            return mayor
